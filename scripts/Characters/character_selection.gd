...
func _on_knight_mouse_entered() -> void:
	...
	player_label.show()
	player_label.set_text('   Description: A disciplined warrior clad in heavy armor, the Knight excels in close 
							   combat and battlefield resilience. 
...
func _on_mage_mouse_entered() -> void:
	...
	player_label.show()
	player_label.set_text('   Description: A master of arcane arts cloaked in mystical robes, the Mage excels in 
							   long-range combat and elemental power.
...
func _on_barbarian_mouse_entered() -> void:
	...
	player_label.show()
	player_label.set_text('   Description: A fierce warrior driven by raw strength and primal fury, the Barbarian 
							   excels in brutal melee combat and relentless aggression.
...
func _on_rouge_mouse_entered() -> void:
	...
	player_label.show()
	player_label.set_text('   Description: A cunning fighter shrouded in shadow, the Rogue excels in stealth, agility 
...
func _on_druid_mouse_entered() -> void:
	...
	player_label.show()
	player_label.set_text('   Description: A guardian of nature and master of elemental balance, The Druid excels 
							   in adaptive magic and healing abilities.
