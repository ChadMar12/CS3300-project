...
@onready var move_state_machine = $Mage/AnimationTree.get("parameters/MoveStateMachine/playback")
@onready var extra_animation = $Mage/AnimationTree.get_tree_root().get_node('ExtraAnimation')	
...
func hit() -> void:
	$Mage/AnimationTree.set('parameters/ExtraOneShot/request',  AnimationNodeOneShot.ONE_SHOT_REQUEST_FIRE)
	attacking = false
